...
module.exports = {
    ...
    audits: [
        './ui_utils/settings/custom-network-requests',
        './ui_utils/settings/custom-network-server-latency',
        //'network-requests',
        'network-rtt',
        //'network-server-latency',
        './ui_utils/settings/custom-main-thread-tasks',
        'metrics',
        'performance-budget',
        'timing-budget',
        'full-page-screenshot',
        ...
        //'final-screenshot',
        './ui_utils/settings/custom-final-screenshot',
    ],
